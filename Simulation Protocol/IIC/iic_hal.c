...
/**
  ...
  * @retval None
  */
void SDA_Input_Mode(IIC_HandleTypeDef *bus)
{
...
/**
  ...
  * @retval None
  */
void SDA_Output_Mode(IIC_HandleTypeDef *bus)
{
    GPIO_InitTypeDef GPIO_InitStructure = {0};
...
/**
  ...
  * @retval None
  */
void SDA_Output(IIC_HandleTypeDef *bus, uint16_t val)
{
    if ( val )
    {
...
/**
  ...
  * @retval None
  */
void SCL_Output(IIC_HandleTypeDef *bus, uint16_t val)
{
    if ( val )
    {
...
/**
  ...
  * @retval GPIO读入一位
  */
uint8_t SDA_Input(IIC_HandleTypeDef *bus)
{
